...
%\subfloat[Throw PTCPN]{\label{fig:throw}\includegraphics[scale=0.3]{Figures/throw.eps}}
%\subfloat[Exit PTCPN]{\label{fig:exit}\includegraphics[scale=0.3]{Figures/exit.eps}}
%\subfloat[Empty PTCPN]{\label{fig:empty}\includegraphics[scale=0.3]{Figures/empty.eps}}\\
%\subfloat[Wait PTCPN]{\label{fig:wait}\includegraphics[scale=0.3]{Figures/wait.eps}}
%\ \ \ \ \subfloat[Assign PTCPN]{\label{fig:assign}\includegraphics[scale=0.3]{Figures/assign.eps}}
%}}
%\end{center}
%\vspace{-0.6cm}
...
%\hspace{-0.2cm}\subfloat[Invoke/Receive PTCPN]{\label{fig:comm1}\includegraphics[scale=0.27]{Figures/communication.eps}}
%\subfloat[$\overline{Reply}$/Reply PTCPN]{\label{fig:comm2}\includegraphics[scale=0.27]{Figures/communication_2.eps}}
%}}
%\end{center}
%\vspace{-0.62cm}
