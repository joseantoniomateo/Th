...
\usepackage[lined,boxed,ruled,linesnumbered,noend]{algorithm2e}
%\usepackage{algorithm}
...
\usepackage[dvipdfm,dvips,breaklinks=true,linktocpage,hypertexnames=false]{hyperref}
\usepackage{breakurl}
