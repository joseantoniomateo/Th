%%%%%%%%%%%%%%%%%%%%%% Section%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Timed-Arc Workflow Nets}\label{sec:tawfn}
...
%\subfloat[Sound and unbounded net with inhibitor arcs]{\label{fig:inhun}
...
\end{tikzpicture}
\captionsetup{type=subfigure}
\caption*{Urgent transitions.}
\label{fig:urgun}
\end{minipage}
%}}
%\vspace{-0.25cm}
\caption{\label{fig:unsound}Sound and unbounded extended timed-arc workflow nets}
%\vspace{-0.3cm}
\end{figure}
